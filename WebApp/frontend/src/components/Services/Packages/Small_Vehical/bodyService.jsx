import '../../css/bodyService.css';
import React, { Component } from 'react';
import axios from 'axios';
import {withRouter} from 'react-router-dom';

class bodyService extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3001/Services/Small_pack_wash')
        .then(res => {
    ...
    updatePackege(id, e){
        ...
        axios.put(`http://localhost:3001/Services/Small_pack/update/${id}`, Packege)
        .then(()=>{
            alert('Small Packege Data Updated !');
        }).catch((err)=>{
            alert(err.message);
        });
    }
    ...
    render() {
        ...
        return(
            <div>
                <h1 className='svfsp'>Small Vehicals - Body Wash Service Package</h1>
            ...
            <div className="maindiv">
                <h2 className="fs">Body Wash Service</h2>
                <div class="container" style={{marginTop:50, marginBottom:30}}>
                    <div class="row">
                        <div class="col" style={{marginLeft:50}}>
                            <h2 className="ser">Services :-</h2>

                                <ul className="serUl">
                                    <li>Full body wash</li>
                                    <li>Tires grooming</li>
                                    <li>External waxing</li>
                                    <li>Greasing</li>
                                </ul>
                        ...
                        <h2 className="time">Taken Time :-</h2>
                            ...
                            <div className="hour">
                            <h2 className="hour0">1/2 hour</h2>
                            </div>
...
export default withRouter(bodyService);
