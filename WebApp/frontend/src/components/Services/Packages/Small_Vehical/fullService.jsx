...
class fullService extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3001/Services/Small_pack_full')
        .then(res => {
    ...
    updatePackege(id, e){
        ...
        .then(()=>{
            alert('Small Package Data Updated !');
        }).catch((err)=>{
            alert(err.message);
        });
    }
    ...
    render() {
        ...
        return(
            <div>
                <h1 className='svfsp'>Small Vehicals - Full Service Package</h1>
                        ...
                        <div class="col" style={{marginLeft:50}}>
                            <h2 className="ser">Services :-</h2>
                                ...
                                <ul className="serUl">
                                    ...
                                    <li>Brake cable change</li>
                                    <li>Clutch cable change</li>
                                    <li>Brake liner change</li>
                                    <li>Greasing</li>
                                </ul>
                            ...
                            <h2 className="part">Spare Parts :-</h2>
                                ...
                                <ul className="partUl">
                                    <li>Engine Oil 2L</li>
                                    <li>02 Brake cable</li>
                                    <li>Clutch cable</li>
                                    <li>02 Brake liner</li>
                                </ul>
