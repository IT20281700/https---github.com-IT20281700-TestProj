...
class acBodyService extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3001/Services/AC_pack_wash')
        .then(res => {
    ...
    render() {
        ...
        return(
            <div>
                <h1 className='svfsp'>A/C Vehicals - Body Service Package</h1>
...
export default withRouter(acBodyService);
