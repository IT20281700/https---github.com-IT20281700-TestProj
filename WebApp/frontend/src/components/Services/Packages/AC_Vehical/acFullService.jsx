...
class acFullService extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3001/Services/AC_pack_full')
        .then(res => {
    ...
    render() {
        ...
        return(
            <div>
                <h1 className='svfsp'>A/C Vehicals - Full Service Package</h1>
...
export default withRouter(acFullService);
