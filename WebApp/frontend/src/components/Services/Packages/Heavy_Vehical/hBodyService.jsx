import '../../css/acBodyService.css';
import React, { Component } from 'react';
import axios from 'axios';
import {withRouter} from 'react-router-dom';

class hBodyService extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3001/Services/Heavy_pack_wash')
        .then(res => {
    ...
    render() {
        ...
        return(
            <div>
                <h1 className='svfsp'>Heavy Vehical And Other - Body Service Package</h1>
            ...
            <div className="maindiv">
                <h2 className="fs">Body Service</h2>
...
export default withRouter(hBodyService);
