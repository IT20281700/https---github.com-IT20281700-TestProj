...
class hHarfBodyWash extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3001/Services/Heavy_pack_harf')
        .then(res => {
    ...
    render() {
        ...
        return(
            <div>
                <h1 className='svfsp'>Heavy Vehical And Other - Harf Body Service Package</h1>
...
export default withRouter(hHarfBodyWash);
