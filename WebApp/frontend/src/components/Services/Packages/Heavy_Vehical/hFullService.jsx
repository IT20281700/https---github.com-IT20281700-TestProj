import '../../css/acFullService.css';
import React, { Component } from 'react';
import axios from 'axios';
import {withRouter} from 'react-router-dom';

class hFullService extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3001/Services/Heavy_pack_full')
        .then(res => {
    ...
    updatePackege(id, e){
        ...
        axios.put(`http://localhost:3001/Services/Heavy_pack/update/${id}`, Packege)
        .then(()=>{
    ...
    render() {
        ...
        return(
            <div>
                <h1 className='svfsp'>Heavy Vehicals And Other - Full Service Package</h1>
            ...
            <div className="maindiv">
                <h2 className="fs">Full Service</h2>
                <div class="container" style={{marginTop:50, marginBottom:30}}>
                    <div class="row">
                        <div class="col" style={{marginLeft:10}}>
                            <h2 className="ser">Services :-</h2>
                                ...
                                <ul className="serUl">
                                    ...
                                    <li>Petral/Deasel filter change</li>
                                    ...
                                    <li>Brack liner change</li>
                                    <li>Alignment repearing</li>
                                    <li>Greasing</li>
                        ...
                        <h2 className="part">Spare Parts :-</h2>
                            ...
                            <ul className="partUl">
                                <li>Engine Oil 5L</li>
                                <li>02 Prtral/Deasel filter</li>
                                <li>Oil filter</li>
                                <li>Air filter</li>
                                <li>04 Brake liner</li>
                            </ul>

                        <h2 className="time">Taken Time :-</h2>

                            <div className="hour">
                            <h2 className="hour0">1 1/2 hour</h2>
                            </div>
...
export default withRouter(hFullService);
